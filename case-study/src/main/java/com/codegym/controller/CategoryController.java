...
public class CategoryController {
    ...
    public ModelAndView showEditForm(@PathVariable Long categoryID){
    ...
    public ModelAndView showDeleteForm(@PathVariable Long categoryID){
        Category category = categoryService.findById(categoryID);
        if(category != null) {
    ...
    public ModelAndView viewCategory(@PathVariable("categoryID") Long categoryID){
        Category category = categoryService.findById(categoryID);
        if(category == null){
